...
//New 1DArray of Song Objects
$scope.objs=[];
var s=0;
//Convert Song 2DArray into a 1DArray;
for(var i =0 ; i< $scope.songs.length; i++){
    for(var j=0; j<5; j++){
        $scope.objs[s] = $scope.songs[i][j];               
        s++;
    } 
}

$scope.questions= $scope.objs;
     
     
$scope.idx=0;

     //Shuffle All Incomplete Lyrics
...
//initialize rows, diagonal, and columns
var c1=0;
var c2 =0;
var c3=0;
var c4 =0;
...
//Shuffle songs within the Bingo Board
...
//Check if song incomplete lyric question matches with song incomplete lyric
...
//unbind the match function for that cell
...
//Check for Bingo
     ...
     //Check for any columns for bingo
